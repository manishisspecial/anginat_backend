...
class SubjectController {
  async createSubject(req, res) {
    ...
    try {
      ...
      sendErrorResponse(
        res,
        error.message ===
          "Name, code, institution, and instructors are required"
          ...
          ? "Invalid instructor ID(s)"
          : error.message ===
            "All instructors must be active users with role 'instructor'"
          ? "Invalid instructors"
          : error.message ===
  ...
  async updateSubject(req, res) {
    ...
    try {
      ...
      const subjectData = req.body;
      if (
        subjectData.institution &&
        subjectData.institution !== institutionId
      ) {
