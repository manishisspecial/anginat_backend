...
class TimetableController {
    ...
    try {
      ...
      sendErrorResponse(
        ...
        error.message ===
          ...
          : error.message === "Invalid ID(s) provided"
          ? "Invalid ID(s)"
          ...
          ? "AcademicClass and degree mismatch"
          : error.message ===
  ...
  async updateTimetable(req, res) {
    ...
    try {
      ...
      const timetableData = req.body;
      if (
        timetableData.institution &&
        timetableData.institution !== institutionId
      ) {
